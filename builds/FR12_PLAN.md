...
**Phase 3. Class coverage (FR-12).** _Progress: 8 of 13. Sorcerer 2026-09-24 (base L1-L6); Wizard 2026-09-24 (base L1-L6 + 3 subclasses); Cleric 2026-09-25 (base L1-L6 + 3 subclasses). The data-only claim failed 8 to 10 ways each time, see the Sorcerer, Wizard and Cleric notes in `BACKLOG_DONE.md` Chores. The roster is now one edit (`class_spines.yaml`) plus a `catalog_build.CLASS_CONFIG` row._
