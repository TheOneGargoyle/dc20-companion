...
3. **Bonan's Titan Grip double was genuinely open and is now CLOSED.** `09` carried "Titan Grip + Dual Wielding, two 2H weapons, one in each raging hand, 2nd attack MCP-free" as an open ruling, and the card was given a small-print caveat on 2026-08-14 rather than asserting it flatly. **Jesse confirmed it 2026-08-15 (via Darryl), 100 per cent**, so `09` line 40 is ticked and the card's small print now records the confirmation instead of the doubt. His 10.5-EV boss turn stands as written in `12`.
