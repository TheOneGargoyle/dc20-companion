...
| BUG-52 | Damage Calculator ignores the **Impact** weapon property (+1 damage on Heavy Hits) | bug | companion+catalog | P2 | ready (Darryl 2026-08-14; 4 of 6 PCs carry an Impact weapon, see note) |
| FR-52 | Roll section: add Versatile +2, Flanking +2, and the decayed Help Dice (d6/d4) | feature | companion | P2 | ready (Darryl 2026-08-14; all three rules-cited, see note) |
