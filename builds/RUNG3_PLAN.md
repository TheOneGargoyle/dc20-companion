...
- **Respec safety UX:** how loud should the "you are editing canon" moment be, and where exactly does the promote-to-canonical step live (in the builder, or as a deliberate file move on your side)? The sandbox principle is settled (the builder never writes the repo directly, export is always deliberate); the UX loudness is a detail for the wireframe.
